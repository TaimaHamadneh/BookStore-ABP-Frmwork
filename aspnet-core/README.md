...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c62b5325-2b08-4ab1-b15d-b1419aa39394
```

> `c62b5325-2b08-4ab1-b15d-b1419aa39394` is the password of the certificate, you can change it to any password you want.
